  ...
  return (
    <main className="flex-1 bg-white text-black">
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col items-center space-y-4 text-center">
            <div className="space-y-2">
              <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl/none">Plan My Trip</h1>
              ...
              <p className="mx-auto max-w-[700px] text-gray-300 md:text-xl">
                Experience unforgettable journeys tailored just for you. From luxury escapes to budget-friendly adventures, Plan My Trip delivers your
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-100">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-center mb-12">Why Choose Plan My Trip?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="bg-white">
              ...
              <CardContent>
                <p>
                  Powered by cutting-edge RAG and LLM technology, Plan My Trip curates your dream vacation from thousands of verified travelers'
                  experiences.
                </p>
              </CardContent>
            </Card>
            <Card className="bg-white">
              ...
              <CardContent>
                <p>
                  From art galleries to street food tours, Plan My Trip crafts the perfect itinerary based on your interests, cuisine preferences, and
                  budget.
                </p>
              </CardContent>
            </Card>
            <Card className="bg-white">
              ...
              <CardContent>
                <p>
                  No more guesswork or generic suggestions. Plan My Trip ensures you have the best time ever, whether you're exploring Delhi's history or
                  Mumbai's nightlife.
                </p>
              </CardContent>
            </Card>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-center mb-12">How Plan My Trip Works</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-black text-white">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="mx-auto max-w-[700px] text-gray-300 mb-8">
            Plan with ease and let Plan My Trip craft your perfect Indian itinerary. From the bustling streets of Delhi to the cultural richness of
